...
export default function DoctorPrescription() {
  ...
  const savePrescription = () => {
    ...
    pharmacistNotifications.unshift({
      id: Date.now(),
      title: "New e-prescription submitted",
      message: `Prescription for ${patientName || "a patient"} is awaiting pharmacist validation.`,
      createdAt: new Date().toLocaleString(),
      read: false,
    });
    localStorage.setItem("pharmacistNotifications", JSON.stringify(pharmacistNotifications));
